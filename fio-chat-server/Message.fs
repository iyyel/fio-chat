...
type Message =
    ...
    | ConnectionNotify of ServerName: string * ConnectedUsername: string * Message: string
    | DisconnectionNotify of ServerName: string * DisconnectedUsername: string * Message: string
